...
The GitHub/pi install source is `git:github.com/eccentricnode/Sugar_Free_PAI`.
The exact remote repo slug is `Sugar_Free_PAI` with capital letters and underscores.
...
about historical wording or the remote slug.
